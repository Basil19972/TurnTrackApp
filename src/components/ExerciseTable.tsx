...
import { createStyles, Table, Checkbox, ScrollArea, Group, Avatar, Text, Button, Container, TextInput, Select } from '@mantine/core';
...
interface Exercisesprops {
 ...
 function TableSelection() {
  ...
  const handleChange = (event: any) => {
    ...
    const [exercisesState, setexercises] = useState([{id: '', name: '', amountOfSets: 0}])
  ...
  async function SenddeleteExercise(id:string){
   ...
   function createTrainingDay(){
    ...
    const trainingDay = {dayPlanname:name, dayName:dayname,exercises:exerciseobjects }
  ...
  return (
    ...
    <ScrollArea>
      ...
      <Container mt={50}>
      <Text size={"xl"} mb={10}>Select some Exercises and Creat your Trainingday</Text>

   <Select label="Select Trainingday" value={dayname} onChange={setdayname} data={["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"]} />
